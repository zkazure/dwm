...
static char *fonts[]          = { "JetBrainsMono Nerd Font Mono:size=10", "NotoColorEmoji:pixelsize=10:antialias=true:autohint=true"  };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_d,          spawn,                  {.v = (const char*[]){ "j4-dmenu-desktop", NULL } } },
